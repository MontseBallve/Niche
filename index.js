...
fetch("productos.json")
  ...
  .then((datos) => {
    ...
    arrayDeProducto.forEach((producto) => {
      ...
      elemento.classList.add("col-xl-3", "col-md-6", "col-xs-12");
      elemento.innerHTML = elemento.innerHTML = `${producto.imagen}
      <div class="descProducto card-body">
